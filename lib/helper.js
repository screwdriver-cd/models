 ...
 * @method getAllRecordss
 * @param  {String}       funcName    Function to fetch. For example: 'getBuilds'
 * @param  {opts}         opts        opts to pass into scan function
 ...
 */
async function getAllRecords(funcName, opts, resultArray, date, index) {
    ...
    return getAllRecords.apply(this, [funcName, opts, resultArray, currentDate, currentIndex]);
}
