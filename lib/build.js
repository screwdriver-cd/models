...
const DEFAULT_BUILD_TIMEOUT = 90 * 60; // seconds
...
class BuildModel extends BaseModel {
    ...
    start() {
        ...
        return this.job
            .then((job) => {
                let buildTimeout = DEFAULT_BUILD_TIMEOUT;

                // buildTimeout is only set in executor-k8s or executor-k8s-vm
                if (this[executor].kubernetes && this[executor].kubernetes.buildTimeout) {
                    buildTimeout = this[executor].kubernetes.buildTimeout * 60;
                }
