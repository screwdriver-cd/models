...
function getExecutorName(annotations, pipeline, provider) {
    ...
    const executorFromAnnotations = annotations ? annotations[executorAnnotation] : '';
    const executorFromPipelineAnnotations = pipelineAnnotations ? pipelineAnnotations[executorAnnotation] : '';
