...
const BLOCKED_BY_SAME_JOB_WAIT_TIME = 5; // in minutes
                    ...
                    getBlockedByIds(pipeline, job)
                        .then(blockedBy => {
                            const config = {
                                ...
                                blockedBySameJob: hoek.reach(job.permutations[0], 'blockedBySameJob', {
                                    default: true
                                }),
                                blockedBySameJobWaitTime: hoek.reach(job.permutations[0], 'blockedBySameJobWaitTime', {
