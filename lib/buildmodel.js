...
const BuildModel = class {
     ...
     * @return {Function} callback          fn(err, result) where result is the build with the specific id
     */
    get(id, callback) {
        const config = {
            table: this.table,
     ...
     * @return {Function} callback           fn(err, result) where result is an array of builds
     */
     ...
     * @return {Function}  callback       fn(err, result) where result is the new build object
     */
